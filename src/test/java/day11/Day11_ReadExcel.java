...
//        Print country, capitol key value pairs as map object
//        {USA = D.C,Frace=Paris,England=London...}
        Map<String,String> countriyCapitals = new HashMap<>();
...
//            ankara  =   sheet1.getRow(3).getCell(1);
...
//            Map put function is used to add key value pains inside the map
            countriyCapitals.put(countries,capitals);
        }
        System.out.println(countriyCapitals);
    }
