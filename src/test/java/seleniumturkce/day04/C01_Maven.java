...
public class C01_Maven {
    public static void main(String[] args) {
        ...
        //class'in basinda implicitywait komutu yazilirsa
...
//  4- Bulunan sonuc sayfasini yazdiralim
//        WebElement sonucYazisiElementi= driver.findElement(By.className("a-section a-spacing-small a-spacing-top-small"));
        //By.className ile locate ettigimiz webelementi class attribute nun degerinde bosluk varsa locate r dogru calsimayabilir
...
//        WebElement ilkUrunElementi= driver.findElement(By.xpath("//span[@class='a-size-medium a-color-base a-text-normal']"));
//        ilkUrunElementi.click();
        // sadece bir click yapacak isek webelementi olusturmaya ve assign etmeye gerek yok direk locate edip sonra click yapabiliriz
